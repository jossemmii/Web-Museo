...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <h2 id="tit1" > Añade una obra </h2>

            <section id="aniadir">
                <form action="realizar_aniadirobra.php" method="post" onsubmit="return validarFormulario()">
                    <label for="titulo">Título:</label>
                    <input type="text" id="titulo" name="titulo">

                    <label for="siglo">Siglo:</label>
                    ...
                    <label for="imagen" id="campo" >Imagen:</label>
